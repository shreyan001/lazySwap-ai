...
class SideShiftAPI {
    constructor(privateKey, demoMode = false) {
    ...
    async checkPermissions(userIP) {
        ...
        try {
            ...
            const response = await axios_1.default.get(`${this.baseURL}/permissions`, {
                headers
            });
    ...
    async getCoins() {
        ...
        try {
            ...
            const response = await axios_1.default.get(`${this.baseURL}/coins`);
    ...
    async createCheckout(checkoutData, userIP) {
        ...
        try {
            ...
            const response = await axios_1.default.post(`${this.baseURL}/checkout`, checkoutData, {
                headers: {
                    'Content-Type': 'application/json',
    ...
    async createVariableSwap(swapData, userIP) {
        ...
        try {
            ...
            const response = await axios_1.default.post(`${this.baseURL}/shifts/variable`, swapData, {
                headers: {
                    'Content-Type': 'application/json',
                    'x-sideshift-secret': this.privateKey,
                    'x-user-ip': ip,
    ...
    // Create a fixed swap
    async createFixedSwap(swapData, userIP) {
        ...
        try {
            ...
            const response = await axios_1.default.post(`${this.baseURL}/shifts/fixed`, swapData, {
                headers: {
                    'Content-Type': 'application/json',
                    'x-sideshift-secret': this.privateKey,
                    'x-user-ip': ip,
    ...
    async getSwapStatus(swapId) {
        ...
        try {
            ...
            const response = await axios_1.default.get(`${this.baseURL}/shifts/${swapId}`, {
                headers: {
                    'x-sideshift-secret': this.privateKey,
                },
            });
    ...
    async createWebhook(targetUrl) {
      ...
      `;
            ...
            const response = await axios_1.default.post(this.graphqlURL, { query: mutation }, {
                headers: {
                    'Content-Type': 'application/json',
                    'x-sideshift-secret': this.privateKey,
                },
    ...
    async getQuote(fromCoin, toCoin, amount, fromNetwork, toNetwork) {
    ...
    async requestQuote(quoteData) {
        ...
        try {
            ...
            const response = await axios_1.default.post(`${this.baseURL}/quotes`, quoteData, {
                headers: {
                    'Content-Type': 'application/json',
                    'x-sideshift-secret': this.privateKey
                }
    ...
    async createFixedShiftFromQuote(shiftData) {
        ...
        try {
            ...
            const response = await axios_1.default.post(`${this.baseURL}/shifts/fixed`, shiftData, {
                headers: {
                    'Content-Type': 'application/json',
                    'x-sideshift-secret': this.privateKey
                }
